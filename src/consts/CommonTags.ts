...
export const CommonTags = {
    ...
    /**
     * Client participates in the DeathLink mechanic, therefore will send and receive a DeathLink
     * {@link NetworkProtocol.NetworkPackets.BouncePacket}.
     */
    DEATH_LINK: "DeathLink",

    /**
     * Tells the server that this client will not send locations and is actually a Tracker. When specified and used with
     * an empty `game` in the {@link NetworkProtocol.NetworkPackets.ConnectPacket}, `game` and `game`'s version
     ...
     * with an empty `game` in the {@link NetworkProtocol.NetworkPackets.ConnectPacket}, `game` and `game`'s version
     * validation will be skipped.
     */
    HINT_GAME: "HintGame",
} as const;
