...
export class Client<TSlotData = AbstractSlotData> {
    ...
    public addListener(event: ServerPacketType | "AnyPacket", listener:
        ...
        this.#emitter.addListener(event, listener as (packet: Packet.ArchipelagoServerPacket) => void);
    }
